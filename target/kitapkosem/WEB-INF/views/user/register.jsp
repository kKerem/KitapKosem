            ...
            <div class="col-lg-6 col-md-8">
                <div class="auth-card">
                    ...
                    <div class="auth-header text-center mb-4">
                        ...
                        <h2 class="auth-title">Aramıza Katılın!</h2>
                    ...
                    <form action="${pageContext.request.contextPath}/register" method="POST" class="auth-form" id="registerForm">
                        ...
                        <div class="form-check mt-2">
                            ...
                            <label class="form-check-label" for="newsletter">
                                Yeni kitaplar ve özellikler hakkında e-posta bildirimleri almak istiyorum.
                            </label>
                        </div>

                        <button type="submit" class="btn btn-success btn-lg w-100 rounded-pill mt-4 mb-4">
