...
<div class="hero-section text-center mb-5">
    <h1 class="display-4 fw-bold mb-3">
        <i class="bi bi-code-slash text-white me-3"></i>
        Geliştirici API
    </h1>
...
<div class="modern-card p-5 text-center">
    ...
    <div class="d-flex gap-3 justify-content-center flex-wrap">
        ...
        <a href="https://github.com/kitapkosem/api-examples" class="btn btn-outline-primary rounded-pill px-4" target="_blank">
