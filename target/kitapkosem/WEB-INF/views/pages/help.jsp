...
<div class="hero-section text-center mb-5">
    <h1 class="display-4 fw-bold mb-3">
        <i class="bi bi-question-circle-fill text-white me-3"></i>
        Yardım Merkezi
    </h1>
    ...
    <div class="col-lg-8">
        <div class="modern-card p-4">
            <div class="input-group input-group-lg">
                ...
                <input type="text" class="form-control border-0" placeholder="Sorunuzu yazın..." id="helpSearch">
...
<div class="row g-4 mb-5">
    <div class="col-lg-4 col-md-6">
        <div class="modern-card p-4 h-100 text-center help-category">
...
<!-- FAQ Section -->
<div class="modern-card p-5 mb-5">
...
<div class="modern-card p-5 text-center">
    ...
    <div class="d-flex gap-3 justify-content-center flex-wrap">
        ...
        <a href="${pageContext.request.contextPath}/pages/feedback" class="btn btn-outline-primary rounded-pill px-4">
