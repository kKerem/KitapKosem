...
<div class="row g-4 mb-5">
    <div class="col-lg-3 col-md-6">
        <div class="p-3 text-center bg-white border rounded faq-category" data-category="general">
            <i class="bi bi-info-circle-fill fs-2 text-dark mb-2"></i>
            <h6 class="fw-bold">Genel Sorular</h6>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="p-3 text-center bg-white border rounded faq-category" data-category="account">
            <i class="bi bi-person-circle fs-2 text-dark mb-2"></i>
            <h6 class="fw-bold">Hesap İşlemleri</h6>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="p-3 text-center bg-white border rounded faq-category" data-category="books">
            <i class="bi bi-book-fill fs-2 text-dark mb-2"></i>
            <h6 class="fw-bold">Kitap İşlemleri</h6>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="p-3 text-center bg-white border rounded faq-category" data-category="technical">
            <i class="bi bi-gear-fill fs-2 text-dark mb-2"></i>
