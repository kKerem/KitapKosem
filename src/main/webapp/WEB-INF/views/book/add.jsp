...
<% request.setAttribute("isIndexPage", true); %>
    ...
    <div class="row justify-content-center pt-5">
        <div class="col-lg-10">
            <div class="add-book-hero rounded-top border border-bottom-0">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <div class="hero-content p-3">
                            ...
                            <h3 class="hero-title fw-semibold">Yeni Kitap Ekle</h3>
                            <p class="hero-subtitle small fw-semibold">Kitap koleksiyonumuza katkıda bulunun ve diğer okuyucularla paylaşın</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="add-book-card p-3 bg-white rounded-bottom border border-top-0">
                ...
                <c:if test="${not empty error and error != ''}">
                    <div class="alert alert-danger small rounded border-0 mb-4" role="alert" style="display: none;">
                ...
                <form action="${pageContext.request.contextPath}/books/add" method="POST" enctype="multipart/form-data" id="addBookForm">
                    ...
                    <div class="form-step" id="step-3">
                        ...
                        <div class="image-upload-area" id="imageUploadArea">
                            <div class="upload-placeholder">
                                ...
                                <button type="button" class="btn btn-outline-primary rounded fw-semibold" onclick="document.getElementById('coverImage').click()">
                        ...
                        <div class="image-preview" id="imagePreview" style="display: none;">
                            <div class="preview-header d-flex justify-content-between align-items-center mb-3">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-danger rounded fw-semibold" onclick="removeImage()">
                                ...
                                <div class="col-md-8">
                                    <div class="preview-details">
                                        ...
                                        <div class="preview-meta mb-3">
                                            <span class="badge bg-primary rounded me-2">
                                                <i class="bi bi-calendar3 me-1"></i>
                                                <span id="previewYear">-</span>
                                            </span>
                                            <span class="badge bg-secondary rounded" id="previewCategoryBadge" style="display: none;">
                    ...
                    <div class="form-navigation">
                        <div class="d-flex justify-content-between align-items-center">
                            <button type="button" class="btn btn-outline-secondary rounded fw-semibold" id="prevBtn" onclick="if(typeof changeStep === 'function') changeStep(-1); else alert('Function loading...');" style="display: none;">
                            ...
                            <div>
                                <button type="button" class="btn btn-primary rounded fw-semibold" id="nextBtn" onclick="if(typeof changeStep === 'function') changeStep(1); else alert('Function loading...');">
                                    Sonraki <i class="bi bi-arrow-right ms-2"></i>
                                </button>
                                <button type="submit" class="btn btn-success rounded fw-semibold" id="submitBtn" style="display: none;">
...
window.changeStep = function(direction) {
    ...
    console.log('=== ADIM DEĞİŞİMİ BAŞLANGICI ===');
    console.log('Direction:', direction);
    console.log('Yön:', direction);
    console.log('Current step before:', currentStep);
    console.log('Mevcut adım (önce):', currentStep);
    ...
    if (direction === 1) {
        ...
        if (!isValid) {
            ...
            console.log('Doğrulama başarısız - adım değişimi durduruluyor');
    ...
    console.log('Hesaplanan yeni adım:', newStep);
    
    if (newStep < 1 || newStep > totalSteps) {
        console.log('Invalid step range - stopping');
        console.log('Geçersiz adım aralığı - durduruluyor');
        return;
    }
    
    // Hide current step
    console.log('Hiding current step:', currentStep);
    console.log('Mevcut adım gizleniyor:', currentStep);
    ...
    console.log('Mevcut adım elementi bulundu:', !!currentStepElement);
    console.log('Current step indicator found:', !!currentStepIndicator);
    console.log('Mevcut adım göstergesi bulundu:', !!currentStepIndicator);
    
    if (currentStepElement) {
        currentStepElement.classList.remove('active');
        console.log('Removed active from step element');
        console.log('Adım elementinden active kaldırıldı');
    }
    if (currentStepIndicator) {
        currentStepIndicator.classList.remove('active');
        console.log('Removed active from step indicator');
        console.log('Adım göstergesinden active kaldırıldı');
        ...
        if (direction === 1) {
            ...
            console.log('Adım göstergesine completed eklendi');
        }
    }
    
    // Show new step
    console.log('Showing new step:', newStep);
    console.log('Yeni adım gösteriliyor:', newStep);
    currentStep = newStep;
    ...
    console.log('Yeni adım elementi bulundu:', !!newStepElement);
    console.log('New step indicator found:', !!newStepIndicator);
    console.log('Yeni adım göstergesi bulundu:', !!newStepIndicator);
    
    if (newStepElement) {
        newStepElement.classList.add('active');
        console.log('Added active to new step element');
        console.log('Yeni adım elementine active eklendi');
    }
    if (newStepIndicator) {
        newStepIndicator.classList.add('active');
        console.log('Added active to new step indicator');
        console.log('Yeni adım göstergesine active eklendi');
    }
    ...
    console.log('=== ADIM DEĞİŞİMİ BİTTİ ===');
    console.log('Final current step:', currentStep);
    console.log('Son mevcut adım:', currentStep);
};

window.updateNavigation = function() {
    console.log('Updating navigation for step:', currentStep);
    console.log('Adım için navigasyon güncelleniyor:', currentStep);
    ...
    if (currentStepText) {
        ...
        console.log('Adım metni güncellendi:', currentStep);
    }
    
    if (prevBtn) {
        prevBtn.style.display = currentStep === 1 ? 'none' : 'inline-block';
        console.log('Previous button display:', prevBtn.style.display);
        console.log('Önceki buton görünümü:', prevBtn.style.display);
    }
    if (nextBtn) {
        nextBtn.style.display = currentStep === totalSteps ? 'none' : 'inline-block';
        console.log('Next button display:', nextBtn.style.display);
        console.log('Sonraki buton görünümü:', nextBtn.style.display);
    }
    if (submitBtn) {
        submitBtn.style.display = currentStep === totalSteps ? 'inline-block' : 'none';
        console.log('Submit button display:', submitBtn.style.display);
        console.log('Gönder butonu görünümü:', submitBtn.style.display);
    }
};

window.validateCurrentStep = function() {
    console.log('Validating step:', currentStep);
    console.log('Adım doğrulanıyor:', currentStep);
    ...
    if (currentStep === 1) {
        ...
        console.log('Başlık değeri:', title ? title.value : 'BULUNAMADI');
        console.log('Author value:', author ? author.value : 'NOT FOUND');
        console.log('Yazar değeri:', author ? author.value : 'BULUNAMADI');
        console.log('Year value:', year ? year.value : 'NOT FOUND');
        console.log('Yıl değeri:', year ? year.value : 'BULUNAMADI');
        
        if (!title || title.value.trim().length < 2) {
            console.log('Title validation failed');
            console.log('Başlık doğrulaması başarısız');
            return false;
        }
        if (!author || author.value.trim().length < 2) {
            console.log('Author validation failed');
            console.log('Yazar doğrulaması başarısız');
            return false;
        }
        if (!year || !year.value || parseInt(year.value) < 1800) {
            console.log('Year validation failed');
            console.log('Yıl doğrulaması başarısız');
            return false;
        }
        
        console.log('Step 1 validation passed');
        console.log('1. adım doğrulaması başarılı');
        return true;
    } else if (currentStep === 2) {
        const description = document.getElementById('description');
        console.log('Description value:', description ? description.value : 'NOT FOUND');
        console.log('Açıklama değeri:', description ? description.value : 'BULUNAMADI');
        
        if (!description || description.value.trim().length < 10) {
            console.log('Description validation failed');
            console.log('Açıklama doğrulaması başarısız');
            return false;
        }
        
        console.log('Step 2 validation passed');
        console.log('2. adım doğrulaması başarılı');
        return true;
    }
    
    console.log('No validation needed for step:', currentStep);
    console.log('Bu adım için doğrulama gerekmiyor:', currentStep);
    return true;
};
...
console.log('=== FONKSİYON KULLANILABİLİRLİK TESTİ ===');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('=== DOM YÜKLENDİ ===');
    console.log('Initializing add book form...');
    console.log('Kitap ekleme formu başlatılıyor...');
    ...
    for (let i = 1; i <= 4; i++) {
        ...
        console.log('Adım ' + i + ' elementi bulundu:', !!stepElement);
        console.log('Step ' + i + ' indicator found:', !!stepIndicator);
        console.log('Adım ' + i + ' göstergesi bulundu:', !!stepIndicator);
    }
    ...
    console.log('Önceki buton bulundu:', !!prevBtn);
    console.log('Next button found:', !!nextBtn);
    console.log('Sonraki buton bulundu:', !!nextBtn);
    console.log('Submit button found:', !!submitBtn);
    console.log('Gönder butonu bulundu:', !!submitBtn);
    console.log('Current step text found:', !!currentStepText);
    console.log('Mevcut adım metni bulundu:', !!currentStepText);
