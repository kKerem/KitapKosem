...
<div class="hero-section bg-white border-bottom p-3 p-lg-5" style="background-image: linear-gradient(rgba(0, 0, 0, .025) 1px, transparent 1px), linear-gradient(to right, rgba(0, 0, 0, .025) 1px, transparent 1px);background-size: 20px 20px;">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <h1 class="profile-name fs-2">${user.username}</h1>
                <p class="profile-email text-muted fs-6">
                    <i class="bi bi-envelope me-2"></i>${user.email}
                </p>
                <div class="profile-badges">
                    <span class="badge fw-semibold bg-white border border-dark text-dark rounded">
                        <i class="bi bi-person-check me-2"></i>Aktif Üye
                    </span>
                    <c:if test="${user.username == 'admin'}">
                        <span class="badge fw-semibold bg-white border border-success text-success rounded">
            ...
            <div class="col-md-3 text-end">
                <button class="btn btn-outline-light rounded" data-bs-toggle="modal" data-bs-target="#editProfileModal">
...
<div class="container my-4">
    <div class="row g-4">
        <div class="col-md-3">
            <div class="border p-3 bg-white border rounded">
                <div class="row align-items-center">
                    <div class="col-auto">
                    ...
                    <div class="col">
                        <div class="stat-content">
                            <h3 class="fw-bolder m-0">${fn:length(userReviews)}</h3>
                            <p class="m-0 text-muted fw-semibold small">Değerlendirme</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="border p-3 bg-white border rounded">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <div class="stat-content">
                            <h3 class="fw-bolder m-0">${favoriteCount}</h3>
                            <p class="m-0 text-muted fw-semibold small">Favori Kitap</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="border p-3 bg-white border rounded">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <div class="stat-content">
                            <h3 class="fw-bolder m-0">${userBooksCount}</h3>
                            <p class="m-0 text-muted fw-semibold small">Eklenen Kitap</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="border p-3 bg-white border rounded">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <div class="stat-content">
                            <h3 class="fw-bolder m-0">${averageRating}</h3>
                            <p class="m-0 text-muted fw-semibold small">Ortalama Puan</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-md-5">
        ...
        <div class="col-lg-8">
            <div class="card-header bg-transparent border-0">
                <div class="d-flex justify-content-between align-items-center mb-3 bg-white rounded border p-3">
                    <h4 class="mb-0">
                        <i class="bi bi-chat-square-text me-2"></i>
                        Değerlendirmelerim <span class="badge bg-primary rounded ms-2">${fn:length(userReviews)}</span>
                    </h4>
                    <div class="dropdown">
                                    ...
                                    <div class="timeline-content">
                                        <div class="review-header mb-2">
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    <h6 class="review-book-title mb-1 d-inline-block me-2">
                                        ...
                                        <div class="review-footer mt-3">
                                            <button class="btn btn-sm btn-outline-primary rounded me-2">
        ...
        <div class="col-lg-4">
            ...
            <div class="bg-white rounded p-3 pb-0 border mb-4">
                <div class="card-header bg-transparent border-0">
                    <h5 class="mb-0 fw-semibold border-bottom pb-3">
                        ...
                        <c:when test="${not empty favoriteBooks}">
                            ...
                            <c:if test="${fn:length(favoriteBooks) > 5}">
                                <div class="text-center mt-3">
                                    <a href="${pageContext.request.contextPath}/favorites" class="btn btn-outline-primary btn-sm rounded">
             ...
             <div class="bg-white rounded border p-3">
                ...
                <div class="d-grid gap-2">
                    <a href="${pageContext.request.contextPath}/books/add" class="btn btn-primary rounded text-start">
                        <i class="bi bi-plus-circle me-2"></i>Yeni Kitap Ekle
                    </a>
                    <a href="${pageContext.request.contextPath}/books" class="btn btn-outline-primary rounded text-start">
                        <i class="bi bi-search me-2"></i>Kitap Ara
                    </a>
                    <a href="${pageContext.request.contextPath}/favorites" class="btn btn-outline-danger rounded text-start">
                        <i class="bi bi-heart me-2"></i>Favorilerim
                    </a>
                    <button class="btn btn-outline-secondary rounded text-start fw-semibold" data-bs-toggle="modal" data-bs-target="#editProfileModal">
        ...
        <div class="modal-content rounded border-0 shadow">
            ...
            <form action="${pageContext.request.contextPath}/profile" method="POST">
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="username" class="form-label fw-medium small">Kullanıcı Adı</label>
                            <input type="text" class="form-control" id="username" name="username" 
                                   value="${user.username}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label fw-medium small">E-posta</label>
                            <input type="email" class="form-control" id="email" name="email" 
                                   value="${user.email}" required>
                        </div>
                        <div class="col-12">
                            <h6 class="fw-bold mb-2">Şifre Değiştir</h6>
                            <label for="currentPassword" class="form-label fw-medium small">Mevcut Şifre</label>
                            <input type="password" class="form-control" id="currentPassword" name="currentPassword">
                        </div>
                        <div class="col-md-6">
                            <label for="newPassword" class="form-label fw-medium small">Yeni Şifre</label>
                            <input type="password" class="form-control" id="newPassword" name="newPassword">
                        </div>
                        <div class="col-md-6">
                            <label for="confirmPassword" class="form-label fw-medium small">Yeni Şifre Tekrar</label>
                ...
                <div class="modal-footer border-0">
                    <button type="button" class="btn btn-outline-secondary rounded fw-semibold" data-bs-dismiss="modal">
                        İptal
                    </button>
